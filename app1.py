...
if uploaded_file is not None:
    ...
    if st.button("Scan Ingredients"):
        ...
        st.success(
            f"Recovered {len(display_df)} ingredients"
        )
        ...
        if best_count >= 4:
            ...
            st.success(
                "🟢 This product contains several highly rated ingredients."
            )

        elif best_count >= 2:

            st.warning(
                "🟡 This product contains some beneficial ingredients."
            )

        else:

            st.error(
                "🔴 This product contains few highly rated ingredients."
            )
        ...
        st.download_button(
            ...
            data=csv,
            file_name="ingredient_scan_results.csv",
            mime="text/csv"
        )
